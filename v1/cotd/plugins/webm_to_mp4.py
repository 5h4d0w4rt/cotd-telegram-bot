...
def webm_to_mp4(
    ...
    def _ffmpeg_runner(inputfile: pathlib.Path, outputfile: pathlib.Path) -> subprocess.CompletedProcess:
...
def webm_to_mp4_inline(
    ...
    video = context.bot.send_video(chat_id=context.dispatcher._cotd_db, video=open(converted_video, "rb"))
