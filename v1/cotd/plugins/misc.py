...
import telegram
import telegram.ext
from v1.cotd.cacher import MediaCache
from v1.cotd.plugins.helpers import cacheable_handler, is_reply, logged_context, check_chance, check_timer
...
def voice_reaction(
    ...
    voice_messages = [
        ...
        "ничего не понял",
        "не могу послушать твоё голосовое, мне оторвало уши",
        "пиши давай",
    ]
